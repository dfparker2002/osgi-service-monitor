...
public final class Constants {
    ...
    public static final int SERVICE_MONITOR_MANAGER_DEFAULT_SEQUENTIAL_FAILURES_BEFORE_NOTIFICATION = 3;
    public static final int SERVICE_MONITOR_MANAGER_DEFAULT_QUEUE_SIZE = 50;
